		...
		<div class="products form">
			...
			<?php echo $this->Form->create('Product', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('idCategoryProduct', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('idExchangeRate', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('idUnit', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						<?php echo $this->Form->input('idSupplier', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						<?php echo $this->Form->input('enable', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
