...
<html>
	<head>
		...
		<title>
			...
			<?php echo $title_for_layout." sale"; ?> 
		</title>
			...
			<ul class="sidebar-menu" style="display: block;">
				...
				<li class="has-sub">
					<a href="javascript:;" class="">
						...
						</span> Hàng Hóa <i class="icon-lock"></i>
						<span class="arrow"></span>
					</a>
					<!-- <ul class="sub">
						<li>
							<?php echo $this->Html->link('Hàng Hóa <i class="icon-lock"></i>',array(),array('escape'=>false)) ?>
						</li>
						<li>
							<?php echo $this->Html->link('Loại Hàng Hóa <i class="icon-lock"></i>',array(),array('escape'=>false)) ?>
						</li>
						<li>
							<?php echo $this->Html->link('Nhà Cung Cấp <i class="icon-lock"></i>',array(),array('escape'=>false)) ?>
						</li>
						<li>
							<?php echo $this->Html->link('Đơn Vị Tính <i class="icon-lock"></i>',array(),array('escape'=>false)) ?>
						</li>
						<li>
							<?php echo $this->Html->link('Tiền Tệ <i class="icon-lock"></i>',array(),array('escape'=>false)) ?>
						</li>
