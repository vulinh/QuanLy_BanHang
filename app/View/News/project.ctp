...
<?php foreach ($news as $news): ?>
    <tr>
        ...
        <td class="actions"> 
            ...
            <?php echo $this->Form->postLink('<i class=" icon-remove"></i>', array('action' => 'delete', $news['News']['id'],1), array('class'=>'tt','escape'=>false,'data-toggle'=>'tooltip','data-original-title'=>'Xóa '.$news['News']['title']), __('Bạn có muốn xóa tin tức "%s?"', $news['News']['title'])); ?>
        </td>
    </tr>
<?php endforeach; ?>
                    </tbody>
