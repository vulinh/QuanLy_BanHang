...
<div class="row-fluid">
  <div class="span2 pull-right">
        ...
        <?php echo $this->Html->link(__('Tin đã gửi'), array('action' => 'listsend'), array('class'=>'btn btn-success')); ?> 
  </div>
</div>
...
<?php foreach ($mails as $mail): ?>
    <tr>
     ...
     //   echo "<td $background>".h($mail['Mail']['idMail']).'</td>';
        echo "<td $background>".$this->Html->link($mail['UsersSent']['name'], array('controller' => 'users', 'action' => 'view', $mail['UsersSent']['id'])).'</td>'; 
    //    echo "<td $background>".$this->Html->link($mail['UsersReceipt']['name'], array('controller' => 'mails', 'action' => 'receipt', $mail['UsersReceipt']['id'])).'</td>';
        echo "<td $background>".$this->Html->link(h($mail['Mail']['subject']),array('action' => 'viewreceipt', $mail['Mail']['idMail'])).'</td>';
    //    echo "<td $background>".h($mail['Mail']['content']).'</td>';
        echo "<td $background>".h($mail['Mail']['date']).'</td>'; 
