...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Mail.idMail')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Mail.idMail'))); ?></li>
				<li class="list-group-item"><?php echo $this->Html->link(__('List Mails'), array('action' => 'index')); ?></li>
			...
			<?php echo $this->Form->create('Mail', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('idMail', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('idUserSent', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('idUserReceipt', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
